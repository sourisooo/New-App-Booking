...
import { Checkbox, CheckBoxList, DateOfStayField, RangeSliderField } from '../../components/common/Fields';
import GuestsCounter from '../../components/ui/GuestsCounter/GuestsCounter';
